 ...
 * @since 0.7.7
 */
@Mojo(name = "report-aggregate-diff", threadSafe = true)
public class ReportAggregateForDiffMojo extends AbstractReportMojo {
	 ...
	 * used instead.
	 */
	@Parameter(defaultValue = "${project.reporting.outputDirectory}/jacoco-aggregate-diff")
	...
	void loadExecutionData(final ReportSupport support) throws IOException {
		...
		GitFileUtil.initDiffCode(project);
